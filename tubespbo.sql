...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 19, 2022 at 07:38 AM
...
INSERT INTO `liker` (`nicknameLike`, `idPostingan`) VALUES
('testing', 0);
...
INSERT INTO `postingan` (`IdPostingan`, `Username`, `Caption`, `GambarPost`, `Likes`, `WaktuPost`, `PostNickname`) VALUES
(0, 'testing', 'Test_Post_1', 'D:\\Tubes_Testing\\TUBES_PBO\\src\\Image\\823290.png', 1, '2022-03-19', 'testing');
...
INSERT INTO `user` (`id_User`, `Username`, `Nickname`, `Email`, `JumlahTeman`, `ProfilePict`) VALUES
(1, 'testing', 'testing', 'testing@gmail.com', 0, 'src/Image/default_profile_pict.png');
